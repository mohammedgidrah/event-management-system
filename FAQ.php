...
</svg>                  <div class="login_nav">Login</div>
                </a>
                <?php else : ?>
                <?php
                    $role = $_SESSION['roles'];
...
<head>
    ...
    .bsb-faq-3 .pagination {
        display: flex;
        justify-content: center;
        padding-top: 20px;
    }

    .bsb-faq-3 .pagination .page-item .page-link {
    ...
    <section class="bsb-faq-3 py-3 py-md-5 py-xl-8">
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="">
                    <h1 class="mb-5 display-5 text-center  ">Frequently Asked Questions</h1>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-11 col-xl-10">
                        <div class="accordion accordion-flush" id="faqAccount">
                            ...
                            $select_Q = "SELECT * FROM faq;";
                            $select_r = mysqli_query($conn, $select_Q);
        ...
        <h2 class='accordion-header' id='faqAccountHeading$i'>
        <button class='accordion-button collapsed bg-transparent fw-bold shadow-none link-danger' type='button' data-bs-toggle='collapse' data-bs-target='#faqAccountCollapse$i' aria-expanded='false' aria-controls='faqAccountCollapse$i'>
        {$row['faq_question']}
        </button>
        </h2>
        <div id='faqAccountCollapse$i' class='accordion-collapse collapse' aria-labelledby='faqAccountHeading$i'>
...
<footer class="footer">
  ...
  <ul class="footer__nav">
    ...
    <li class="nav__item nav__item--extra">
      <h2 class="nav__title1">Technology</h2>
